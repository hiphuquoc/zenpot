@if(!empty($breadcrumb))
   ...
   @php
      ...
      $marginLeftForLogo   = !empty($marginLeftForLogo)&&$marginLeftForLogo==true ? 'marginLeftForLogo' : '';
   @endphp
   <div class="breadcrumbBox">
      <div class="maxLine_1">
         <a href="/{{ $language }}" title="{{ $title }}" class="breadcrumbBox_home {{ $marginLeftForLogo }}" aria-label="{{ $title }}">{{ $title }}</a>
