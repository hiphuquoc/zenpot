        ...
        <div class="designBox_item reverse990">
            ...
            <div class="designBox_item_content">
                <div class="designBox_item_content_skills">
                    <div class="designBox_item_content_skills_item">
                        <div class="designBox_item_content_skills_item_number">
                            3.800+
                        </div>
                        <div class="designBox_item_content_skills_item_text">
                            Khách hàng tin dùng sản phẩm Zenpot
                        </div>
                    </div>
                    <div class="designBox_item_content_skills_item">
                        <div class="designBox_item_content_skills_item_number">
                        ...
                        <div class="designBox_item_content_skills_item_text">
                            Chậu cây cao cấp được giao tận tay
                        </div>
                    </div>
                    <div class="designBox_item_content_skills_item">
                        <div class="designBox_item_content_skills_item_number">
                    ...
                    <div class="designBox_item_content_skills_item">
                        ...
                        <div class="designBox_item_content_skills_item_text">
                            Mẫu thiết kế đỉnh cao và độc quyền
                        </div>
                    </div>
                    <div class="designBox_item_content_skills_item">
                        <div class="designBox_item_content_skills_item_number">
        ...
        <div class="designBox_item">
            <div class="designBox_item_content">
                <div class="designBox_item_content_titleLarge">
                    Danh mục sản phầm của Zenpot
                </div>
                <h2 class="designBox_item_content_title">
                    <div class="designBox_item_content_title_bold">Đa dạng và độc đáo</div>
                    <div>Đáp ứng mọi nhu cầu xanh</div>
                </h2>
                <div class="designBox_item_content_description">
                    <p>Từ chậu mini trang trí bàn làm việc, chậu bonsai tinh xảo đến các mẫu decor độc đáo cho sân vườn, Zenpot mang đến bộ sưu tập đa dạng để đáp ứng trọn vẹn nhu cầu trồng hoa, cây cảnh và trang trí của bạn.</p>
                </div>
            </div>
