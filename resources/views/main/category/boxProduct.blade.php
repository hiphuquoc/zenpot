...
<!-- Products Grid -->
<div id="js_loadMoreWallpaper_box" class="products-grid">
    <!-- tải bằng ajax loadMoreWallaper -->
    {{-- @if($total>0)
...
@push('scriptCustom')
    <script type="text/javascript">
        ...
        function loadMoreWallpaper(requestLoad = 10) {
            /* lấy dữ liệu */
            ...
            if(boxCategory.length&&!boxCategory.hasClass('loading')){
                if(isFirstLoad){
                    loadMoreWallpaperToController("{{ $total }}", true);
                }else {
