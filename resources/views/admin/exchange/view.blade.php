...
@section('content')
    @php
        ...
        $submit         = 'admin.exchange.createAndUpdate';
    ...
    <input type="hidden" id="exchange_info_id" name="exchange_info_id" value="{{ !empty($item->id)&&$type!='copy' ? $item->id : 0 }}" />
                    ...
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @include('admin.exchange.formPage', [
