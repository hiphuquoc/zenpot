...
@section('content')
    @php
        ...
        $submit         = 'admin.exchangeTag.createAndUpdate';
    ...
    <input type="hidden" id="exchange_tag_id" name="exchange_tag_id" value="{{ !empty($item->id)&&$type!='copy' ? $item->id : 0 }}" />
        ...
        <div class="pageAdminWithRightSidebar withRightSidebar">
            <div class="pageAdminWithRightSidebar_header" style="z-index:1000;position:relative;">
                ...
                @include('admin.template.languageBox', [
                    'item' => $item,
                    'language' => $language,
                    'routeName' => 'admin.exchangeTag.view',
                ])
            </div>
            ...
            <div class="pageAdminWithRightSidebar_main">
                    ...
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @include('admin.exchangeTag.formPage', [
                ...
                <div class="pageAdminWithRightSidebar_main_rightSidebar">
                    ...
                    @include('admin.form.buttonAction', [
                        'routeBack' => 'admin.exchangeTag.list',
                    ])
                    <!-- action support -->
