...
<div class="titlePage">Danh Sách Tags của Sàn kết nối</div>

@include('admin.exchangeTag.search', compact('list'))
...
{{-- <!-- Nút thêm -->
<a href="{{ route('admin.exchangeTag.view') }}" class="addItemBox">
    ...
    <script type="text/javascript">
        function deleteItem(id){
            if(confirm('{{ config("admin.alert.confirmRemove") }}')) {
                $.ajax({
                    url         : "{{ route('admin.exchangeTag.delete') }}",
                    type        : "get",
                    dataType    : "html",
                    data        : { id : id }
                }).done(function(data){
