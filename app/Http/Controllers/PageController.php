...
class PageController extends Controller{
    ...
    //     $styles             = Style::all();
    //     $events             = Event::all();
    //     return view('main.category.promotion', compact('item', 'language', 'products', 'categories', 'styles', 'events', 'breadcrumb', 'viewBy'));
    // }
    ...
    //         return view('main.category.search', compact('item', 'language', 'titlePage', 'products', 'categories', 'styles', 'events', 'breadcrumb', 'viewBy'));
    //     }
