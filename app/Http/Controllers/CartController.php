...
class CartController extends Controller{
    ...
    public static function index(Request $request, $slugCart){
        ...
        return view('main.cart.index', compact('item', 'itemSeo', 'language', 'breadcrumb', 'products', 'detailCart'));
    }
    ...
    public static function addToCart(Request $request){
        ...
        if(!empty($infoProduct)){
            ...
            $result = view('main.cart.cartMessage', [
    ...
    public static function viewSortCart(Request $request){
        ...
        $response = view('main.cart.cartSort', compact('products', 'detailCart', 'urlPageCart', 'language'))->render();
    ...
    public static function removeProductCart(Request $request){
        ...
        $result['isEmpty']      = '';
        if(empty($cartNew)){
            $result['isEmpty']  = view('main.cart.emptyCart', compact('language'))->render();
        }
        return json_encode($result);
    }
