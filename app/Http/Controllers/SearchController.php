...
class SearchController extends Controller {
    ...
    private static function searchPremiumWallpaper($keySearch, $language){
        ...
        if(empty($keySearch)) {
            return view('main.template.emptySearch', compact('language'))->render();
        }
        ...
        if($products->isNotEmpty()) {
            return view('main.search.premiumWallpaper', compact('products', 'language', 'keySearch', 'count'));
        }
    ...
    private static function searchCategoryInfo($keySearch, $language) {
        ...
        if ($categories->isNotEmpty()) {
            return view('main.search.categoryInfo', compact('categories', 'language', 'keySearch', 'count'));
        }
    ...
    private static function searchBlogInfo($keySearch, $language){
        ...
        // Trả về giao diện phù hợp
        if($blogs->isNotEmpty()){
            return view('main.search.blogInfo', compact('blogs', 'language', 'keySearch', 'count'));
        }
